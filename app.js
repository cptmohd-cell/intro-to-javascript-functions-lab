...
console.log('Exercise 1 Result:', maxOfTwoNumbers(4, 5));
console.log('Exercise 1 Result:', maxOfTwoNumbers(6, 2));
...
console.log('Exercise 4 Result:', generateEmail("mu.mawla", "gmail.com"));
console.log('Exercise 4 Result:', generateEmail("cpt.mohd", "hotmail.com"));
...
console.log('Exercise 5 Result:', greetUser("Maryam", "afternoon"));
console.log('Exercise 5 Result:', greetUser("Ali", "eveining"));
...
console.log('Exercise 6 Result:', maxOfThree(60, 120, 24));
console.log('Exercise 6 Result:', maxOfThree(80, 36, 55));
...
console.log('Exercise 7 Result:', calculateTip(80, 40));
...
console.log('Exercise 8 Result:', convertTemperature(104, "F"));
...
console.log('Exercise 10 Result:', calculateGrade(96));
console.log('Exercise 10 Result:', calculateGrade(63));
...
function createUsername(firstName, lastName) {
    ...
    return firstPart + lastPart + totalChars;
}

console.log('Exercise 11 Result:', createUsername("Samantha", "Green"));
console.log('Exercise 11 Result:', createUsername("Mohamed", "Mawla"));
console.log('Exercise 11 Result:', createUsername("Maryam", "Saleh"));
console.log('Exercise 11 Result:', createUsername("Yaqoob", "Alhashimi"));
